...
#TARGET_KERNEL_SOURCE := kernel/acer/a100
#TARGET_KERNEL_CONFIG := a100_defconfig
TARGET_PREBUILT_KERNEL := device/acer/a100/prebuilt/zImage
BOARD_KERNEL_CMDLINE :=
BOARD_KERNEL_BASE := 0x10000000
BOARD_PAGE_SIZE := 0x00000800

# Recovery
#TARGET_RECOVERY_KERNEL := device/acer/a100/recovery/recovery_kernel
#TARGET_RECOVERY_FSTAB := device/acer/a100/recovery/recovery.fstab
TARGET_RECOVERY_FSTAB := device/acer/100/ramdisk/fstab.picasso
